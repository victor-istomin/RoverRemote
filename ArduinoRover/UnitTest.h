...
# include "utils.h"
  ...
  inline void testAnswer()
  {
     ...
     Serial.print(" * enoughBufferTest. Written: "); Serial.print(written, DEC); Serial.print("; dump: "); dumpArray(Serial, enoughBytes);
     ...
     Serial.print(" * enoughBufferTest. Written: "); Serial.print(written, DEC); Serial.print("; dump: "); dumpArray(Serial, manyBytes);
